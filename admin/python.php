<?php
    ...
    $target = '../assets/images/upload/'. $imageName;
    move_uploaded_file($_FILES['image']['tmp_name'], $target);
            
    mysqli_query($con,"insert into python (pname, pdesc, images) values ('$pname','$pdesc','$imageName')") or die("failed to query database".mysqli_error());
